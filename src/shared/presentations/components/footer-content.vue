...
<div class="grid bg-primary mt-4 align-content-start">
  <div class="col-12 ml-3 align-items-center justify-content-center">
    <p>Copyrigth &copy; 2026 ACME Studios</p>
  </div>
  <div class="col-12 ml-3 align-items-center justify-content-center">
    <p>{{t('authoring-phrase.intro')}} <i class="pi pi-heart"/>
       {{t('authoring-phrase.use')}} <a href="https://primevue.org/" target="_blank">PrimeVue</a>
      {{t('authoring-phrase.author',{brand: 'ACME'})}}
    </p>
    <p>
      {{t('footer.powered-by')}} <a href="https://www.newsapi.org/" target="_blank">NewsAPI.org</a>
